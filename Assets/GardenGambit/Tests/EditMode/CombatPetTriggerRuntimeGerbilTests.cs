...
{
    public sealed class
        CombatPetTriggerRuntimeGerbilTests
    {
        [Test]
        public void Catalogue_RegistersStableIdentityAndSharedDependencies()
        {
            ...
            Assert.That(
                CombatPetDefinitionIds.GerbilValue,
                Is.EqualTo(
                    "pet.gerbil"));
            ...
            var factory =
                registry.GetFactory(
                        CombatPetDefinitionIds.Gerbil)
                    as GerbilPetTriggerSourceFactory;
        ...
        [TestCase(CombatSide.Player)]
        [TestCase(CombatSide.Enemy)]
        public void ResolutionRunner_AppliesGerbilAfterFirstSurvivedAttack(
            CombatSide side)
        {
            var environment =
                new Environment(
            ...
            Assert.That(
                environment.CountAttackGainEvents(),
                Is.EqualTo(1));
        ...
        [TestCase(10)]
        [TestCase(14)]
        public void ResolutionRunner_RankOutsideTwoThroughSixDoesNotTrigger(
            int rank)
        {
        ...
        private sealed class Environment
        {
            ...
            public int CountAttackGainEvents()
            {
                var count = 0;
