...
{
    public sealed class
        CombatPetTriggerRuntimeFruitBatTests
    {
        [Test]
        public void Catalogue_RegistersStableIdentityAndSharedDependencies()
        {
            ...
            Assert.That(
                CombatPetDefinitionIds.FruitBatValue,
                Is.EqualTo(
                    "pet.fruit_bat"));
            ...
            var factory =
                registry.GetFactory(
                        CombatPetDefinitionIds.FruitBat)
                    as FruitBatPetTriggerSourceFactory;
        ...
        [TestCase(CombatSide.Player)]
        [TestCase(CombatSide.Enemy)]
        public void ResolutionRunner_AppliesFruitBatAfterFirstSurvivedAttack(
            CombatSide side)
        {
            var environment =
                new Environment(
        ...
        public void ResolutionRunner_NonFruitCardDoesNotTrigger(
            CombatCardSuit suit)
        {
