...
{
    public sealed class HummingbirdPetHpGainTriggerHandler : CombatPetHpGainTriggerHandler
    {
        ...
        public HummingbirdPetHpGainTriggerHandler(
            CombatSide side,
            ...
            out BoardPosition targetPosition)
        {
            ...
            if (!sourceEvent.IsFromAnotherSource || sourceEvent.TargetSide != context.Side ||
