...
{
    public sealed class HawkPetTriggerSource : ICombatTriggerSource
    {
        private readonly CombatPetTriggerSource _petTriggerSource;

        public HawkPetTriggerSource(
            CombatSide side,
        ...
        public HawkPetBattleStartTriggerHandler Handler { get; }
        ...
        public IEnumerable<CombatTriggerCandidate<ICombatTriggerHandler>>
            DiscoverTriggers(CombatState state, CombatEvent sourceEvent)
        {
