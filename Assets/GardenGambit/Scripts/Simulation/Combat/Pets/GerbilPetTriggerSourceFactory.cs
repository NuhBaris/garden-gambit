...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public GerbilPetTriggerSourceFactory(
            ...
            CombatEventLog eventLog)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Gerbil factory requires a valid " +
                    "Pet DefinitionId.",
                ...
                CombatPetState pet)
        {
                ...
                side != CombatSide.Enemy)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(side),
                    side,
                    "Gerbil source factory requires " +
            ...
            if (pet.DefinitionId != PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "the Gerbil factory registration.",
                    nameof(pet));
            }
