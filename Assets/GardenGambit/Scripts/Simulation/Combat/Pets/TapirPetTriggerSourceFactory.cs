...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public TapirPetTriggerSourceFactory(
                ...
                attackGainResolver)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Tapir factory requires a valid " +
                    "Pet DefinitionId.",
                ...
                CombatPetState pet)
        {
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "Tapir factory registration.",
                    nameof(pet));
            }

            return new ICombatTriggerSource[]
            {
                new TapirPetTriggerSource(
                    side,
                    pet.InstanceId,
                    _usageCommitter,
                    _attackGainResolver)
