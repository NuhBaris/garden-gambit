...
{
    public sealed class JackalopePetTriggerSourceFactory :
        ICombatPetTriggerSourceFactory
    {
        ...
        public JackalopePetTriggerSourceFactory(
                ...
                finalRankModifierRegistry)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Jackalope factory requires a valid " +
                    "Pet DefinitionId.",
            ...
            CombatPetState pet)
        {
                ...
                side != CombatSide.Enemy)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(side),
                    side,
                    "Jackalope source factory requires " +
            ...
            if (pet.DefinitionId != PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "the Jackalope factory registration.",
                    nameof(pet));
            }
