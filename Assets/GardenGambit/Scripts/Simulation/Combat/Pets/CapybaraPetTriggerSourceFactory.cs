...
{
    public sealed class
        CapybaraPetTriggerSourceFactory :
        ICombatPetTriggerSourceFactory
    {
        ...
        public CapybaraPetTriggerSourceFactory(
                ...
                sourceDamageModifierRegistry)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Capybara factory requires a valid " +
                    "Pet DefinitionId.",
                ...
                CombatPetState pet)
        {
                ...
                side != CombatSide.Enemy)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(side),
                    side,
                    "Capybara source factory requires " +
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "the Capybara factory registration.",
                    nameof(pet));
            }
