...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public PikaPetTriggerSourceFactory(
                ...
                CombatPetState pet)
        {
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "Pika factory registration.",
                    nameof(pet));
            }

            return new ICombatTriggerSource[]
            {
                new PikaPetTriggerSource(
                    side,
                    pet.InstanceId,
                    _usageCommitter,
                    _finalRankModifierRegistry)
