...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public KoalaPetTriggerSourceFactory(
                ...
                CombatPetState pet)
        {
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "Koala factory registration.",
                    nameof(pet));
            }

            return new ICombatTriggerSource[]
            {
                new KoalaPetTriggerSource(
                    side,
                    pet.InstanceId,
                    _usageCommitter,
                    _targetDamageReductionRegistry)
