...
{
    public sealed class JackalopePetTriggerSource :
        ICombatTriggerSource
    {
        private readonly CombatPetBattleEndTriggerSource
            _battleEndTriggerSource;

        public JackalopePetTriggerSource(
            CombatSide side,
        ...
        public CombatPetTriggerOrderKeyProvider
            OrderKeyProvider =>
                _battleEndTriggerSource.OrderKeyProvider;
        ...
        {
            return _battleEndTriggerSource.DiscoverTriggers(
                state,
                sourceEvent);
        }
    }
