...
{
    public sealed class HummingbirdPetTriggerSource : ICombatTriggerSource
    {
        private readonly CombatPetTriggerSource _petTriggerSource;

        public HummingbirdPetTriggerSource(
            CombatSide side,
            ...
            CombatAttackGainResolver attackGainResolver)
        {
            ...
            Handler = new HummingbirdPetHpGainTriggerHandler(
                side, petInstanceId, usageCommitter, attackGainResolver);
            _petTriggerSource = new CombatPetTriggerSource(side, petInstanceId, Handler);
        }

        public HummingbirdPetHpGainTriggerHandler Handler { get; }
        public CombatSide Side => Handler.Side;
        public InstanceId PetInstanceId => Handler.PetInstanceId;
        public CombatPetCardTriggerUsageCommitter UsageCommitter => Handler.UsageCommitter;
        ...
        {
            return _petTriggerSource.DiscoverTriggers(state, sourceEvent);
        }
    }
}
