...
{
    public sealed class LynxPetBattleEndTriggerHandler : CombatPetBattleEndTriggerHandler
    {
        ...
        public LynxPetBattleEndTriggerHandler(
            CombatSide side,
        ...
        protected override void ResolveAtBattleEnd(CombatPetBattleEndContext context, CombatPetState pet)
        {
            ...
            foreach (var slot in eligibleSlots)
            {
                ...
                {
                    throw new OverflowException("Lynx final Rank bonus would overflow a target's modifier.");
                }
