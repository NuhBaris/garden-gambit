...
{
    public sealed class LlamaPetTriggerSourceFactory :
        ICombatPetTriggerSourceFactory
    {
        ...
        public LlamaPetTriggerSourceFactory(
                ...
                targetDamageReductionRegistry)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Llama factory requires a valid " +
                    "Pet DefinitionId.",
                ...
                CombatPetState pet)
        {
            ...
            if (pet.DefinitionId != PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "the Llama factory registration.",
                    nameof(pet));
            }
