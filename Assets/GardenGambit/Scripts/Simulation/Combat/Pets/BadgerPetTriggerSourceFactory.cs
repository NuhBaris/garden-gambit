...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public BadgerPetTriggerSourceFactory(
                ...
                CombatPetState pet)
        {
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "Badger factory registration.",
                    nameof(pet));
            }

            return new ICombatTriggerSource[]
            {
                new BadgerPetTriggerSource(
                    side,
                    pet.InstanceId,
                    _usageCommitter,
                    _targetDamageReductionRegistry)
