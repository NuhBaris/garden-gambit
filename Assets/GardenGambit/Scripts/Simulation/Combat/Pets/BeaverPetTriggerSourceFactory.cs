...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public BeaverPetTriggerSourceFactory(
                ...
                finalRankModifierRegistry)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Beaver factory requires a valid " +
                    "Pet DefinitionId.",
                ...
                CombatPetState pet)
        {
                ...
                side != CombatSide.Enemy)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(side),
                    side,
                    "Beaver source factory requires " +
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "Beaver factory registration.",
                    nameof(pet));
            }

            return new ICombatTriggerSource[]
            {
                new BeaverPetTriggerSource(
                    side,
                    pet.InstanceId,
                    _usageCommitter,
                    _finalRankModifierRegistry)
