...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public HazelDormousePetTriggerSourceFactory(
                ...
                targetDamageReductionRegistry)
        {
            if (!petDefinitionId.IsValid)
            {
                throw new ArgumentException(
                    "Hazel Dormouse factory requires a valid " +
                    "Pet DefinitionId.",
                ...
                CombatPetState pet)
        {
                ...
                side != CombatSide.Enemy)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(side),
                    side,
                    "Hazel Dormouse source factory requires " +
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "the Hazel Dormouse factory registration.",
                    nameof(pet));
            }
