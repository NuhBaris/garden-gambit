...
namespace GardenGambit.Simulation.Combat
{
        ...
        ICombatPetTriggerSourceFactory
    {
        ...
        public LynxPetTriggerSourceFactory(
                ...
                CombatPetState pet)
        {
                ...
                PetDefinitionId)
            {
                throw new ArgumentException(
                    ...
                    "Lynx factory registration.",
                    nameof(pet));
            }

            return new ICombatTriggerSource[]
            {
                new LynxPetTriggerSource(
                    side,
                    pet.InstanceId,
                    _usageCommitter,
                    _finalRankModifierRegistry)
