...
{
    public sealed class CombatPetDeathTriggerSource :
        ICombatTriggerSource
    {
        private readonly CombatPetTriggerSource
            _petTriggerSource;

        public CombatPetDeathTriggerSource(
            CombatPetDeathTriggerHandler handler)
        {
            if (handler == null)
            {
        ...
        public CombatPetDeathTriggerHandler Handler
        {
            get;
        }
